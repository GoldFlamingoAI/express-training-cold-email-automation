...
```
Loaded: AGENTS.md ✓  PHASES.md ✓  CODEX_TASK_RECIPES.md ✓  NOTES.md ✓  ERRORS.md ✓
...
Bring Claude in to fix AGENTS.md/CODEX_TASK_RECIPES.md before resuming.
```
...
Any judgment call not covered by CODEX_TASK_RECIPES.md → NOTES.md, same PR:
