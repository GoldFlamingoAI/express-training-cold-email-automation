...
Codex appends an entry whenever a decision is made that's not covered by CODEX_TASK_RECIPES.md.
...
(empty — first entry will be logged when Codex starts Phase 1)
