...
AGENTS.md / PHASES.md / PLAYBOOK.md, customizing CI per stack, branch
...
Watch for these signals and tighten AGENTS.md / PLAYBOOK.md when they appear:

| Signal | Tighten |
|--------|---------|
| Same scope creep type 2x | AGENTS.md "Never Do" |
| Same dep added without approval | AGENTS.md "New Dependency" |
| Same architectural mistake | PLAYBOOK.md phase recipe |
...
```
Read AGENTS.md, PHASES.md, PLAYBOOK.md, NOTES.md, ERRORS.md from the repo root.
